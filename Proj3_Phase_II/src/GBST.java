...
////////////////////////////////
		...
		if (curr.getAVLHeaderGrade() == student.data.getAvg()) {
			comp3 = 0;
		} else if ((curr.getAVLHeaderGrade() > student.data.getAvg()) && curr.hasLeft())////// 100% there is somthing wrong
			comp3 = 999;
		else if ((curr.getAVLHeaderGrade() < student.data.getAvg()) && curr.hasRight())////// 100% there is somthing wrong
			comp3 = -100;
////////////////////////////////
